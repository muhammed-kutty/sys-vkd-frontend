  ...
  return (
    <div className="spclcontainer">
      ...
      <div className="row mt-5 mb-5 ">
        <div
          className="p-5 rounded d-flex flex-wrap justify-content-between align-items-center "
          style={{ width: "100%" }}
        >
          ...
          <div className=" col-sm-12 col-lg-6">
            ...
            <div
              className=" border-end  p-5 rounded text-light "
              style={{
                height: "500px",
                background: " linear-gradient(to right, #47f6ff, #2d9fff)",
              }}
            >
              ...
              <div className="mb-4">
                ...
                <span className="px-3"> valakkudaunit@gmail.com</span>
              </div>
              <div>
                <IoLocationOutline size={24} />{" "}
                <span className="px-3">Kunnamangalam ,valakkuda</span>
              </div>
            </div>
            </div>
...
<div className="col-sm-12 col-lg-6 ">
            ...
            <div className="px-5 bg-light p-5 rounded" 
            style={{ height: "500px" }}
            >
              <form>
                <div className="mb-3">
